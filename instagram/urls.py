...
urlpatterns = [
    ...
    path('company/<int:company_id>/instagram/oauth/', views.FBOAuthRedirectView.as_view(), name='instagram_oauth'),
    path('callback/', views.FBCallbackView.as_view(), name='instagram_callback'),
